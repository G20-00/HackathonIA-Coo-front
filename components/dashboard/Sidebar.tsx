/**
 * Sidebar Component
 * Barra lateral de navegación con items del menú
 * - Navegación principal de la aplicación
 * - Indicador visual del item activo
 * - Iconos y labels para cada sección
 */
...
const menuItems = [
  ...
  { id: 'tienda', label: 'Tienda', href: '/dashboard/tienda', icon: 'store' },
  { id: 'simulador', label: 'Simulador IA', href: '/dashboard/simulador', icon: 'brain' },
  { id: 'alianzas', label: 'Alianzas', href: '/dashboard/alianzas', icon: 'handshake' },
  { id: 'pagos', label: 'Pagos', href: '/dashboard/pagos', icon: 'credit-card' },
  { id: 'soporte', label: 'Soporte', href: '/dashboard/soporte', icon: 'support' },
  { id: 'admin', label: 'Admin', href: '/dashboard/admin', icon: 'settings' },
];
      ...
      <div className="flex h-full flex-col">
        ...
        <div className="border-t border-slate-200 p-4">
          <div className="rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 p-3">
            ...
            <p className="mt-1 text-xs text-slate-600">Contacta a soporte</p>
